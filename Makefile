...
export TERRAFORM_PROVIDER_SOURCE ?= maxlaverse/bitwarden
export TERRAFORM_PROVIDER_REPO ?= https://github.com/maxlaverse/terraform-provider-bitwarden
export TERRAFORM_PROVIDER_VERSION ?= 0.7.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-bitwarden
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= $(TERRAFORM_PROVIDER_REPO)/releases/download/v$(TERRAFORM_PROVIDER_VERSION) #https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-bitwarden_v0.7.2_x5
...
xpkg.build.provider-bitwarden: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/bitwardens/01-delete.yaml.tmpl.
